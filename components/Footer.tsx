        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/courses" className="text-primary-300 hover:text-white transition-colors">
                  All Courses
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/instructors" className="text-primary-300 hover:text-white transition-colors">
                  Instructors
                </Link>
              </li>
              <li>
